    ...
    <div className="section" >
      ...
      <div className="event" id="friday">
        ...
        <div className="right">
          ...
          <a title="Add to Calendar" class="addeventatc" data-id="RP5016394" href="https://www.addevent.com/event/RP5016394" target="_blank" rel="nofollow">Add to Calendar</a>
        </div>
      </div>
      <div className="event" id="saturday">
        ...
        <div className="right">
          ...
          <a title="Add to Calendar" class="addeventatc" data-id="HB5016402" href="https://www.addevent.com/event/HB5016402" target="_blank" rel="nofollow">Add to Calendar</a>
        </div>
      </div>
      <div className="event" id="sunday">
        ...
        <div className="right">
          ...
          <a title="Add to Calendar" class="addeventatc" data-id="jJ5016409" href="https://www.addevent.com/event/jJ5016409" target="_blank" rel="nofollow">Add to Calendar</a>
        </div>
      </div>
    </div>
  );
